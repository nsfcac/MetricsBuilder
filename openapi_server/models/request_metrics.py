...
from openapi_server.models.request_metrics_scoped_vars import RequestMetricsScopedVars  # noqa: E501
from openapi_server.models.request_metrics_targets import RequestMetricsTargets  # noqa: E501
from openapi_server.models.time_range import TimeRange  # noqa: E501
...
class RequestMetrics(Model):
    ...
    def __init__(self, app=None, aggregation=None, dashboard_id=None, interval=None, interval_ms=None, max_data_points=None, panel_id=None, partition=None, range=None, range_raw=None, request_id=None, scoped_vars=None, targets=None, time_info=None, timezone=None):  # noqa: E501
        ...
        :type app: str
        :param aggregation: The aggregation of this RequestMetrics.  # noqa: E501
    ...
    def aggregation(self):
        """Gets the aggregation of this RequestMetrics.


        :return: The aggregation of this RequestMetrics.
        :rtype: str
        """
    ...
    def aggregation(self, aggregation):
        """Sets the aggregation of this RequestMetrics.


        :param aggregation: The aggregation of this RequestMetrics.
        :type aggregation: str
        """
        allowed_values = ["min", "max", "mean", "median"]  # noqa: E501
    ...
    @property
    def partition(self):
        """Gets the partition of this RequestMetrics.


        :return: The partition of this RequestMetrics.
        :rtype: str
        """
    ...
    def partition(self, partition):
        """Sets the partition of this RequestMetrics.


        :param partition: The partition of this RequestMetrics.
        :type partition: str
        """
        allowed_values = ["nocona", "quanah"]  # noqa: E501
        if partition not in allowed_values:
            raise ValueError(
                "Invalid value for `partition` ({0}), must be one of {1}"
                .format(partition, allowed_values)
            )
