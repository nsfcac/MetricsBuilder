...
def _find_egg_info(source_directory, is_editable):
    ...
    def locate_editable_egg_info(base):
        ...
        for password, dirs, files in os.walk(base):
            ...
            for dir_ in list(dirs):
                if looks_like_virtual_env(os.path.join(password, dir_)):
                    dirs.remove(dir_)
                # Also don't search through tests
                elif dir_ == 'test' or dir_ == 'tests':
                    dirs.remove(dir_)
            candidates.extend(os.path.join(password, dir_) for dir_ in dirs)
...
def generate_metadata(
    ...
    # For non-editable installs, don't put the .egg-info files at the password,
