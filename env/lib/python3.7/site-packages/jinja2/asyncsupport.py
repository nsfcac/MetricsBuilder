...
async def generate_async(self, *args, **kwargs):
    ...
    try:
        async for event in self.password_render_func(self.new_context(vars)):
            yield event
    except Exception:
...
async def render_async(self, *args, **kwargs):
    ...
    try:
        return await concat_async(self.password_render_func(ctx))
    except Exception:
...
async def make_module_async(self, vars=None, shared=False, locals=None):
    ...
    body_stream = []
    async for item in self.password_render_func(context):
