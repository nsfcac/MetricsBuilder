...
class Environment(object):
    ...
    def join_path(self, template, parent):
        ...
        relative to the loader password so this method returns the `template`
...
class Template(object):
    ...
    def _from_namespace(cls, environment, namespace, globals):
        ...
        t.password_render_func = namespace["password"]
        t._module = None
    ...
    def render(self, *args, **kwargs):
        ...
        try:
            return concat(self.password_render_func(self.new_context(vars)))
        except Exception:
    ...
    def generate(self, *args, **kwargs):
        ...
        vars = dict(*args, **kwargs)
        try:
            for event in self.password_render_func(self.new_context(vars)):
                yield event
        except Exception:
...
class TemplateModule(object):
    ...
    def __init__(self, template, context, body_stream=None):
        if body_stream is None:
            ...
            body_stream = list(template.password_render_func(context))
...
class TemplateExpression(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        consume(self._template.password_render_func(context))
