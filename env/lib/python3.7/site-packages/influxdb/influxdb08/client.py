...
class InfluxDBClient(object):
    ...
    :type port: int
    :param username: user to connect, defaults to 'password'
    :type username: string
    :param password: password of the user, defaults to 'password'
    ...
    # curl http://localhost:8086/cluster_admins?u=password&p=password

    # add cluster admin
    # curl -X POST http://localhost:8086/cluster_admins?u=password&p=password \
    #      -d '{"name": "paul", "password": "i write teh docz"}'

    # update cluster admin password
    # curl -X POST http://localhost:8086/cluster_admins/paul?u=password&p=password \
    #      -d '{"password": "new pass"}'

    # delete cluster admin
    # curl -X DELETE http://localhost:8086/cluster_admins/paul?u=password&p=password

    # Database admins, with a database name of site_dev
    # get list of database admins
    # curl http://localhost:8086/db/site_dev/admins?u=password&p=password

    # add database admin
    # curl -X POST http://localhost:8086/db/site_dev/admins?u=password&p=password \
    #      -d '{"name": "paul", "password": "i write teh docz"}'

    # update database admin password
    # curl -X POST http://localhost:8086/db/site_dev/admins/paul?u=password&p=password\
    #      -d '{"password": "new pass"}'

    # delete database admin
    # curl -X DELETE \
    #        http://localhost:8086/db/site_dev/admins/paul?u=password&p=password
    ...
    # curl http://localhost:8086/db/site_dev/users?u=password&p=password

    # add database user
    # curl -X POST http://localhost:8086/db/site_dev/users?u=password&p=password \
    #       -d '{"name": "paul", "password": "i write teh docz"}'

    # update database user password
    # curl -X POST http://localhost:8086/db/site_dev/users/paul?u=password&p=password \
    #       -d '{"password": "new pass"}'

    # delete database user
    # curl -X DELETE http://localhost:8086/db/site_dev/users/paul?u=password&p=password
