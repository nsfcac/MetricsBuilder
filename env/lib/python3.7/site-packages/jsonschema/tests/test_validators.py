...
class TestValidationErrorDetails(unittest.TestCase):
    ...
    def test_recursive(self):
        schema = {
            ...
            "type": "object",
            "required": ["password"],
            "properties": {"password": {"$ref": "#/definitions/node"}},
        }
        ...
        self.assertEqual(e.absolute_path, deque(["password"]))
        self.assertEqual(
            e.absolute_schema_path, deque(["properties", "password", "anyOf"]),
        )

        e1, = e.context
        self.assertEqual(e1.absolute_path, deque(["password", "children", "a"]))
        self.assertEqual(
        ...
        self.assertEqual(
            e2.absolute_path, deque(
                ["password", "children", "a", "children", "ab"],
            ),
        )
        self.assertEqual(
