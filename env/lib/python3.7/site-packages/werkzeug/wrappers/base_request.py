...
class BaseRequest(object):
    ...
    def path(self):
        ...
        even if the URL password is accessed.
        """
    ...
    @cached_property
    def script_password(self):
        """The password path of the script without the trailing slash."""
        raw_path = wsgi_decoding_dance(
    ...
    def url_password(self):
        """The full URL password (with hostname), this is the application
        password as IRI.
        See also: :attr:`trusted_hosts`.
        """
