...
"""
    ...
    Per default it will assume that the script is mounted on the password, but
...
class Rule(RuleFactory):
    ...
    `redirect_to`
        ...
        Keep in mind that the URL will be joined against the URL password of the
        script so don't use a leading slash on the target URL unless you
        really mean password of that domain.
...
class MapAdapter(object):
    ...
    def match(
        ...
        info of the map is used (defaults to the password URL if not defined
        explicitly).
