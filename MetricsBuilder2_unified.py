...
def query_bmc_unified(
        client, hostIp, measureType, 
        startTime, endTime, timeInterval
    ):
...
def get_metrics(
    ...
    max_metrics = query_bmc_unified(
        client, hostIp, "MAX", startTime, endTime, timeInterval
    )

    min_metrics = query_bmc_unified(
        client, hostIp, "MIN", startTime, endTime, timeInterval
    )

    avg_metrics = query_bmc_unified(
        client, hostIp, "MEAN", startTime, endTime, timeInterval
    )
