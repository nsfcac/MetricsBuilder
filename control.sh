...
gunicorn --certfile='/home/username/SSL_Certificate/influx_ttu_edu_cert.cer' --keyfile='/home/username/SSL_Certificate/server.key' --workers=5 --timeout 120 -b 0.0.0.0:8080 'openapi_server.__main__:app' --limit-request-line 0
