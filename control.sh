...
gunicorn --certfile='/home/lijie/SSL_Certificate/influx_ttu_edu_cert.cer' --keyfile='/home/lijie/SSL_Certificate/server.key' --timeout 120 -b 0.0.0.0:8080 'openapi_server.__main__:app' --limit-request-line 0
