...
def main():
    ...
    query = """SELECT MAX("FAN_1") as "FAN_1","FAN_2","FAN_3","FAN_4","host","error" FROM Fan_Speed WHERE host='10.101.3.53' AND time >= '2019-04-26T00:00:00Z' AND time <= '2019-04-26T05:00:00Z'' GROUP BY *, time(5m) SLIMIT 1"""
    result = list(client.query(query).get_points())
