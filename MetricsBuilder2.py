...
def main():
    ...
    query = """SELECT MAX("CPU1 Temp") as "CPU1 Temp" MAX("CPU2 Temp") as "CPU2_Temp" FROM CPU_Temperature WHERE host='10.101.3.53'AND time >= '2019-04-26T00:00:00Z' AND time <= '2019-04-26T05:00:00Z' GROUP BY *, time(5m) LIMIT 5"""
