...
def process_node_data(node_list: list, node_data: dict, value: str) -> dict:
    ...
    for node in node_list:
        memory_usage = [item[value] for item in node_data[node]["node_data"]["MemUsage"]]
        cpu_usage = [item[value] for item in node_data[node]["node_data"]["CPUUsage"]]
        power_usage = [item[value] for item in node_data[node]["node_data"]["NodePower"]]
        ...
        FAN_1 = [item[value] for item in node_data[node]["node_data"]["FAN_1"]]
        FAN_2 = [item[value] for item in node_data[node]["node_data"]["FAN_2"]]
        FAN_3 = [item[value] for item in node_data[node]["node_data"]["FAN_3"]]
        FAN_4 = [item[value] for item in node_data[node]["node_data"]["FAN_4"]]
        ...
        json_data[node] = {
            ...
            "job_id": node_data[node]["job_data"]
        }
